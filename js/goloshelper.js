...
function showQuery(operation)
{
	...
	var replies = 0;
	steem.api.getContentReplies(operation.author, operation.permlink, function(err, result) {
		console.log(err, result);
		replies = result.length;		
	});
	
	
	a_div.innerHTML = "<div style='font-size: 12px; background-image:url(\"https://golos.today/images/messages.png\");'><strong>"+replies+"</strong></div>";
